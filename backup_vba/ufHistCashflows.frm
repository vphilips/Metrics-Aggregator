VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufHistCashflows 
   Caption         =   "Historical Cashflows"
   ClientHeight    =   320
   ClientWidth     =   330
   OleObjectBlob   =   "ufHistCashflows.frx":0000
   ...
   Begin MSForms.CommandButton btnSubmit 
      ...
      Width           =   60
   End
   Begin MSForms.TextBox txtInvestorTransactionQuarter 
      Height          =   18
      Left            =   102
      TabIndex        =   17
      Top             =   198
      Width           =   200
   End
   Begin MSForms.Label lblInvestorTransactionQuarter 
      ...
      Width           =   90
   End
   Begin MSForms.TextBox txtInvestorTransactionDate 
      Height          =   18
      Left            =   102
      TabIndex        =   15
      Top             =   174
      Width           =   200
   End
   Begin MSForms.Label lblInvestorTransactionDate 
      Caption         =   "Inv. Txn Date"
      Height          =   18
      Left            =   6
      TabIndex        =   14
      Top             =   174
   ...
   End
End
Attribute VB_Name = "ufHistCashflows"
...
Private Sub btnSubmit_Click()
    ...
    BuildParams pNames, pValues, _
        ...
        "@InvestorTransactionDate", Me.txtInvestorTransactionDate.Value, _
        "@InvestorTransactionQuarter", Me.txtInvestorTransactionQuarter.Value
    
    ' 3. Execute SP
    Dim rs As Object
    Set rs = ExecuteSP("sp_GetHistoricalCashflows", pNames, pValues)
